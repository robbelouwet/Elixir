...
def main(args):
    ...
    if not success:
        print("elixir.org failed to provide signature file, "
              "but elixircore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("elixir.org and elixircore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Elixir Core binary release "
