...
When complete, it will have produced `Elixir-Qt.dmg`.
...
apt install cpio
git clone https://github.com/elixir-core/apple-sdk-tools.git
...
the file-order will change between invocations. The patch can be seen here: [cdrkit-deterministic.patch](https://github.com/elixir/elixir/blob/master/depends/patches/native_cdrkit/cdrkit-deterministic.patch).
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/elixir-core/elixir-detached-sigs).
