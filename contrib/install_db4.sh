...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the elixir repository."
  exit 1
fi
...
# See https://github.com/elixir/elixir/issues/16064
...
echo 'When compiling elixird, run `./configure` in the following way:'
echo
