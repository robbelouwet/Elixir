...
int main()
{
    ...
    auto op0Result = elixirconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, elixirconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
