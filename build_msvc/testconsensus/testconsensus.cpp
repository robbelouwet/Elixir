...
// elixir includes.
#include <..\src\script\elixirconsensus.h>
...
int main()
{
    std::cout << "elixirconsensus version: " << elixirconsensus_version() << std::endl;
    ...
    auto op0Result = elixirconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, elixirconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
