#!/usr/bin/env python3
# Copyright (c) 2017-2018 The Elixir Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test external signer.

Verify that a elixird node can use an external signer command.
...
class RPCSignerTest(ElixirTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart elixird with -signer=<cmd>',
