...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ElixirTestFramework
    pass


class ExampleTest(ElixirTestFramework):
    # Each functional test is a subclass of the ElixirTestFramework class.
    ...
    def custom_method(self):
        ...
        ElixirTestFramework class so other tests can use it."""
