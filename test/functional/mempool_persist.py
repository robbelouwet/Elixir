...
By default, elixird will dump mempool on shutdown and
...
class MempoolPersistTest(ElixirTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent elixird from writing mempool.dat to disk. Verify that `savemempool` fails")
