...
class P2PPermissionsTests(ElixirTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].elixirconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].elixirconf, 'w', encoding="utf8") as f:
            f.write(newText)
