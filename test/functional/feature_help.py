...
"""Verify that starting elixir with -h works as expected."""

from test_framework.test_framework import ElixirTestFramework
from test_framework.util import assert_equal

class HelpTest(ElixirTestFramework):
    ...
    def run_test(self):
        self.log.info("Start elixir with -h for help text")
        ...
        self.log.info("Start elixir with -version for version information")
        ...
        self.log.info("Start elixird with -fakearg to make sure it does not start")
