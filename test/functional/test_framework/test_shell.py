...
class TestShell:
    """Wrapper Class for ElixirTestFramework.

    The TestShell class extends the ElixirTestFramework
    ...
    class __TestShell(ElixirTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ElixirTestFramework child class.
            self.num_nodes = 1
