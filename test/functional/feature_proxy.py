#!/usr/bin/env python3
# Copyright (c) 2015-2019 The Elixir Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test elixird with different proxy configuration.

Test plan:
- Start elixird's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on elixird side:
...
class ProxyTest(ElixirTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: elixird's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
