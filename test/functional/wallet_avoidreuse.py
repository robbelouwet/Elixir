...
class AvoidReuseTest(ElixirTestFramework):
    ...
    def test_full_destination_group_is_preferred(self):
        '''
        Test the case where [1] only has 11 outputs of 1 ELXR in the same reused
        ...
        # Send 11 outputs of 1 ELXR to the same, reused address in the wallet
        for _ in range(11):
            self.nodes[0].sendtoaddress(new_addr, 1)
    ...
    def test_all_destination_groups_are_used(self):
        '''
        Test the case where [1] only has 22 outputs of 1 ELXR in the same reused
        address and tries to send a payment of 20.5 ELXR. The wallet
        ...
        # Send 22 outputs of 1 ELXR to the same, reused address in the wallet
        for _ in range(22):
            self.nodes[0].sendtoaddress(new_addr, 1)
