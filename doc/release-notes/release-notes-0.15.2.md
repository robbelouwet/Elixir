Elixir Core version *0.15.2* is now available from:

  <https://elixircore.org/bin/elixir-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in elixir-tx (TheBlueMatt)
