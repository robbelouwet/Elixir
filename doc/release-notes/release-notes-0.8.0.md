Elixir-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/elixir/files/Elixir/elixir-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Elixir
...
New/changed settings (command-line or elixir.conf file)
--------------------------------------------------------
