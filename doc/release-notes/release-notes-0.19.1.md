...
Elixir Core version 0.19.1 is now available from:

  <https://elixircore.org/bin/elixir-core-0.19.1/>
...
From Elixir Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Elixir Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Elixir Core does not yet change appearance when
...
- #17488 fix "elixird already running" warnings on macOS (fanquake)
