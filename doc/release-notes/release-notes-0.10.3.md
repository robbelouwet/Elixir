Elixir Core version 0.10.3 is now available from:

  <https://elixir.org/bin/elixir-core-0.10.3/>
...
(see https://github.com/elixir/elixir/pull/6793, as well as the 0.11.0
