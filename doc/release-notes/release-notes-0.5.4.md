Elixir version 0.5.4 is now available for download at:
http://sourceforge.net/projects/elixir/files/Elixir/elixir-0.5.4/
...
http://gitorious.org/elixir/elixird-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Elixir-Qt notifications under Growl 1.3.
Increase required age of Elixir-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxElixir properly when installing Elixir-Qt over it. (Windows)
