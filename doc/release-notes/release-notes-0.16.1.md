Elixir Core version 0.16.1 is now available from:

  <https://elixircore.org/bin/elixir-core-0.16.1/>
...
- #12843 `df38b13` Test starting elixird with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure elixird processes are cleaned up when tests end (sdaftuar)
