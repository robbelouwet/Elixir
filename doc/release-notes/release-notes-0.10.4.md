Elixir Core version 0.10.4 is now available from:

  <https://elixir.org/bin/elixir-core-0.10.4/>
...
- #6953 `43c2789` Split elixir-tx into its own package
- #6953 `dfe0d4d` Include elixir-tx binary on Debian/Ubuntu
