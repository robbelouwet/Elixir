Elixir Core version 0.9.2.1 is now available from:

  https://elixir.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ELXR to 0.01 ELXR
...
- Fix "Start elixir on system login"
