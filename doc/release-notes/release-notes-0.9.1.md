Elixir Core version 0.9.1 is now available from:

  https://elixir.org/bin/0.9.1/
...
elixird from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Elixir Core software:
