Download URL: https://sourceforge.net/projects/elixir/files/Elixir/elixir-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ELXR fee schedule (users still pay 0.01 ELXR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #elixir00 - #elixir99
