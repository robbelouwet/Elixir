...
This document provides guidelines for internationalization of the Elixir Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `elixir_en.ts` remains unchanged.
