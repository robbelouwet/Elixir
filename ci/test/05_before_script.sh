...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Elixir
else
  DOCKER_EXEC echo \> \$HOME/.elixir
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/elixir/elixir/pull/18288#discussion_r433189350 for
  # details.
