...
static void SetupElixirTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " elixir-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  elixir-tx [options] <hex-tx> [commands]  Update hex-encoded elixir transaction\n" +
            "or:     elixir-tx [options] -create [commands]   Create hex-encoded elixir transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded elixir transaction
