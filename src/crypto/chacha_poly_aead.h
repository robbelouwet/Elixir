// Copyright (c) 2019 The Elixir Core developers
...
/* A AEAD class for ChaCha20-Poly1305@elixir.
 *
 ...
 *
 * The chacha20-poly1305@elixir combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@elixir cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@elixir are relatively fast in
