 ...
 * for both elixird and elixir-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/elixir/bips/blob/master/bip-0014.mediawiki)
 */
