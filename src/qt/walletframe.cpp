...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, ElixirGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &ElixirGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &ElixirGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &ElixirGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &ElixirGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &ElixirGUI::updateWalletStatus);
    connect(gui, &ElixirGUI::setPrivacy, walletView, &WalletView::setPrivacy);
