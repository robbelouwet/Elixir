// Copyright (c) 2015-2020 The Elixir Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ElixirAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_elixir-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_elixir-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_elixir-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = ElixirUnits::formatWithUnit(unit, balance, false, ElixirUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    ElixirAmountField* amountInput = receiveCoinsDialog.findChild<ElixirAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_elixir-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
