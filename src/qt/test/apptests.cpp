...
//! Entry point for ElixirApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ElixirApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ElixirGUI tests.
void AppTests::guiTests(ElixirGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ElixirGUI::consoleShown, this, &AppTests::consoleTests);
