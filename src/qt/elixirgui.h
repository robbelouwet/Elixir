...
/**
  Elixir GUI main class. This class represents the main window of the Elixir UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ElixirGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ElixirGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~ElixirGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a elixir wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Elixir Transaction from file or clipboard */
