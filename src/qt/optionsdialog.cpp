    ...
    mapper(nullptr)
{
    ...
    ui->elixirAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->elixirAtStartup);
    ...
    ui->elixirAtStartup->setToolTip(ui->elixirAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->elixirAtStartup->setText(ui->elixirAtStartup->text().arg(PACKAGE_NAME));

    ui->openElixirConfButton->setToolTip(ui->openElixirConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ElixirUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->elixirAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openElixirConfButton_clicked()
{
