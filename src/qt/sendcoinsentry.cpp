    ...
    platformStyle(_platformStyle)
{
    ...
    // normal elixir address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying elixir address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ElixirAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
